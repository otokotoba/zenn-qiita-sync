...
var parseUrl = __nccwpck_require__(7052),
    isSsh = __nccwpck_require__(6247);
...
var gitUp = __nccwpck_require__(1502);
...
// Dependencies
var protocols = __nccwpck_require__(7065);
...
var parsePath = __nccwpck_require__(4289);
...
function convertFrontmatter(outputPath) {
    return function _convertFrontmatter(inputContent) {
        const { data, content } = (0, gray_matter_1.default)(inputContent);
        ...
        const frontmatter = js_yaml_1.default.dump(dataCloned);
        return `---\n${frontmatter}---\n${content}`;
    };
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.zennMarkdownToQiitaMarkdown = void 0;
var zenn_markdown_to_qiita_markdown_1 = __nccwpck_require__(3371);
Object.defineProperty(exports, "zennMarkdownToQiitaMarkdown", ({ enumerable: true, get: function () { return zenn_markdown_to_qiita_markdown_1.zennMarkdownToQiitaMarkdown; } }));
...
const git_url_parse_1 = __importDefault(__nccwpck_require__(3398));
function getCurrentBranch() {
    return (0, child_process_1.execSync)('git rev-parse --abbrev-ref HEAD').toString().trim();
}
function getRemoteUrl() {
    return (0, child_process_1.execSync)('git config --get remote.origin.url').toString().trim();
}
function getRepoInfo() {
    const gitInfo = (0, git_url_parse_1.default)(getRemoteUrl());
    return {
        owner: gitInfo.owner,
        repo: gitInfo.name,
...
function replaceImagePaths(inputContent) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.replaceMessageToNote = replaceMessageToNote;
function replaceMessageToNote(inputContent) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.replaceToggle = replaceToggle;
function replaceToggle(inputContent) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.zennMarkdownToQiitaMarkdown = zennMarkdownToQiitaMarkdown;
const convert_frontmatter_1 = __nccwpck_require__(4979);
const replace_image_paths_1 = __nccwpck_require__(6424);
const replace_message_to_note_1 = __nccwpck_require__(2806);
const replace_toggle_1 = __nccwpck_require__(8586);
function zennMarkdownToQiitaMarkdown(inputContent, outputPath) {
    const pipeline = [
        (0, convert_frontmatter_1.convertFrontmatter)(outputPath),
        replace_image_paths_1.replaceImagePaths,
        replace_message_to_note_1.replaceMessageToNote,
        replace_toggle_1.replaceToggle,
    ];
...
const lib_1 = __nccwpck_require__(2915);
const { inputPath, outputPath, watch } = yargs_1.default
    .command('* <inputPath> [outputPath]', 'convert Zenn markdown to Qiita markdown')
    ...
    .alias('help', 'h')
    .parseSync();
function convertAndWrite(inputPath, outputPath) {
    const inputContent = (0, fs_1.readFileSync)(inputPath, 'utf8');
    const outputContent = (0, lib_1.zennMarkdownToQiitaMarkdown)(inputContent, outputPath);
    (0, fs_1.writeFileSync)(outputPath, outputContent, 'utf8');
}
function main() {
    try {
        const isDirectory = (0, fs_1.statSync)(outputPath).isDirectory();
        const outputFilepath = isDirectory
            ? (0, path_1.join)(outputPath, (0, path_1.basename)(inputPath))
            : outputPath;
        convertAndWrite(inputPath, outputFilepath);
        console.log(`Output written to ${outputFilepath}`);
        if (watch) {
            console.log('Watching for changes...');
            (0, fs_1.watchFile)(inputPath, { persistent: true, interval: 1000 }, () => {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(__nccwpck_require__.s = 4649);
